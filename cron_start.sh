...
if ! screen -list | grep -q $SCREEN_NAME; then
  ...
  sleep 5
  screen -d -L -S $SCREEN_NAME -m python3 /home/nvidia/sam/main-torch0.3-compatible.py --display --cam 1 --consecutive 5 --threshold 75  --fullscreen --database weights/REALTIME-DB.tar
else
